                ...
                <div class="page-body">
                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            {!! Form::open(['class'=>'new','url'=>route('admin.partners.create')]) !!}
                            ...
                            <div class="form-group row col-md-12">
                                {!! Form::label('name','Adres strony:',['class'=>'col-form-label']) !!}
                                <div class="col-sm-10 col-lg-3">
                                    {!! Form::text('name',null,['class'=>'form-control','required']) !!}
                                </div>
                                {!! Form::label('balance','Stan konta:',['class'=>'col-form-label']) !!}
                                <div class="col-sm-10 col-lg-3">
                                    {!! Form::number('balance',null,['class'=>'form-control','required','step' => '0.001']) !!}
                                </div>
                            </div>
                            <div class="form-group row col-md-12">
                                ...
                                {!! Form::label('password_confirmation','Powtórz hasło:',['class'=>'col-form-label']) !!}
                                <div class="col-sm-10 col-lg-3">
                    ...
                    <div class="card edit" style="display: none;">
                        ...
                        <div class="card-block">
                            ...
                            {!! Form::open(['class'=>'edit','url'=>route('admin.partners.edit',['id'=>null])]) !!}
                            <div class="form-group row col-md-12">
                                {!! Form::label('name','Login:',['class'=>'col-form-label']) !!}
                                <div class="col-sm-10 col-lg-3">
                                    {!! Form::text('name',null,['class'=>'form-control','required']) !!}
                            ...
                            <div class="form-group row col-md-12">
                                ...
                                <div class="col-sm-10 col-lg-3">
                                    {!! Form::url('site',null,['class'=>'form-control','required']) !!}
                                </div>
                                {!! Form::label('balance','Stan konta:',['class'=>'col-form-label']) !!}
                                <div class="col-sm-10 col-lg-3">
                                    {!! Form::number('balance',null,['class'=>'form-control','required','step' => '0.0001']) !!}
                                </div>
                            </div>
                            <div class="form-group row col-md-12">
                                {!! Form::label('password','Hasło:',['class'=>'col-form-label']) !!}
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5>Lista partnerów</h5>
                            <span>Tutaj wyświetlana jest lista użytkowników za pomocą tego narzędzia możesz ich edytować, usuwać lub dodawać.</span>
                            <div class="card-header-right">
                                <i class="icofont icofont-rounded-down"></i>
                                <i class="icofont icofont-refresh"></i>
                                <i class="icofont icofont-close-circled"></i>
                                        ...
                                        $(document).ready(function () {
                                            window.datatable = $('#datatable').DataTable({
                                                columns: [
                                                    ...
                                                    {data: 'site', "sClass": 'site'},
                                                    {data: 'balance', "sClass": 'balance'},
