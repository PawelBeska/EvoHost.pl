                            ...
                            <div class="page-body">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <span>Poniżej znajduje się historia wypłat na konto</span>
                                                            ...
                                                            columns: [
                                                                ...
                                                                {data: 'created_at', "sClass": 'created_at'},
                                                                {
                                                                    ...
                                                                    "defaultContent": '<div class="btn-group " role="group" data-toggle="tooltip" data-placement="top" title="" data-original-title=".btn-xlg">\n' +
                                                                        ...
                                                                        '                                                <button type="button" class="btn btn-mini btn-primary"><i class="fa fa-external-link-square"></i>STATUS</button>\n' +
                                                                        ...
                                                                        '                                                    <a class="dropdown-item waves-effect waves-light" href="#">Wypłacone</a>\n' +
                                                                        '                                                    <a class="dropdown-item waves-effect waves-light" href="#">Oczekujące</a>\' +
                                                                        '                                                    <a class="dropdown-item waves-effect waves-light" href="#">Anulowane</a>\' +
                                                                        '                                                </div>\n' +
                                                                        '                                            </div>\n' +
